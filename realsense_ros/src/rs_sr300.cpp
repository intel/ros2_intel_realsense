...
namespace realsense
{
RealSenseSR300::RealSenseSR300(rs2::context ctx, rs2::device dev, rclcpp::Node & node)
...
void RealSenseSR300::publishTopicsCallback(const rs2::frame & frame)
{
...
Result RealSenseSR300::paramChangeCallback(const std::vector<rclcpp::Parameter> & params)
{
  auto result = Result();
...
void RealSenseSR300::publishAlignedDepthTopic(const rs2::frame & frame, const rclcpp::Time & time)
{
...
void RealSenseSR300::publishSparsePointCloud(const rs2::points & points, const rs2::video_frame & color_frame, const rclcpp::Time & time)
{
...
void RealSenseSR300::publishDensePointCloud(const rs2::points & points, const rs2::video_frame & color_frame, const rclcpp::Time & time)
{
  const rs2::vertex * vertex = points.get_vertices();
